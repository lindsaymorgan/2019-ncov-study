...
date='2020/2/1'
for date in ['2020/2/1','2020/2/3','2020/2/6','2020/2/9','2020/2/12','2020/2/15','2020/2/18']:
    ...
    raw_data[f'guess_qianxi_{date}']=[pow(10,i) for i in lm_s.predict(X_1)]
raw_data.drop_duplicates(keep='first',inplace=True,subset='provinceName')
raw_data.to_csv('guess_by_qianxi.csv',index=0,encoding='utf-8-sig',sep=',')
# plt.legend()
# plt.xlabel('湖北迁入率 %')
# plt.ylabel('确诊人数')
