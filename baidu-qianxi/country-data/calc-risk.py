...
qianxi=pd.read_csv(f'baiduqianxi_country_level_20{today.strftime("%y%m%d")}.csv')
raw_data=pd.read_csv(f'province-day-summary-{today}.csv')
...
plt.title('疫情风险值前十名', loc='center', fontsize='20',
          fontweight='bold')
plt.savefig(f'risk-top10-{today}.jpg', bbox_inches='tight')