...
def getdata(indate):
    ...
    url='https://huiyan.baidu.com/migration/provincerank.jsonp?dt=city&id=420100&type=move_out&date=20200122'
    ...
    url = 'https://huiyan.baidu.com/migration/provincerank.jsonp?dt=city&id=420100&type=move_in&date=20200122'
    req = urllib.request.Request(url, headers=headers, method='GET')
    response = urllib.request.urlopen(req)
    ...
    data.to_csv(f'baiduqianxi_wuhan_level_20200122.csv',index=0,encoding='utf-8-sig',sep=',')
