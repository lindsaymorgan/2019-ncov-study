...
def getdata(indate):
    ...
    url='https://huiyan.baidu.com/migration/provincerank.jsonp?dt=country&type=move_out&date='+str(indate)
    ...
    url = 'https://huiyan.baidu.com/migration/provincerank.jsonp?dt=country&type=move_in&date=' + str(indate)
    req = urllib.request.Request(url, headers=headers, method='GET')
    response = urllib.request.urlopen(req)
    ...
    data.to_csv(f'/mnt/data/Lindsay/2019-ncov/program/everyday-run/country-data/baiduqianxi_country_level_{indate}.csv',index=0)
