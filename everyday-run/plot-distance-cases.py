...
data=pd.read_csv(f'/mnt/data/Lindsay/2019-ncov/program/dxy-data/nice-dxy-data/city-pivot-day-summary-{today}.csv')
...
plt.legend()
plt.savefig(f'/mnt/data/Lindsay/2019-ncov/program/everyday-run/result/distance-cases-{today}.jpg', bbox_inches='tight')
plt.show()
