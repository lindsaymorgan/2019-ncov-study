...
result=result[(result['tau']<=80) & (result['tau']>=0)]
...
num_dict=dict.fromkeys([round(i*bins,2) for i in range(base+1,ceil+1)],0)
...
plt.savefig(f'5-limit-I{I_limit}-multi-cities-hist-{today}.jpg', bbox_inches='tight')
plt.show()