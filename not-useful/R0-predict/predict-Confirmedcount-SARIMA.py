...
dt=pd.read_csv('../increase-log/country-day-summary-2020-02-11.csv')
...
y_hat_avg = test.copy()
fit1 = sm.tsa.statespace.SARIMAX(train.country_confirmedCount, order=(2, 2, 0),seasonal_order=(0,1,1,7)).fit()
y_hat_avg['SARIMA'] = fit1.predict(start="2020-02-02", end="2020-02-13", dynamic=True)
plt.plot(train['country_confirmedCount'], label='Train',marker='o')
plt.plot(test['country_confirmedCount'], label='Test',marker='o')
